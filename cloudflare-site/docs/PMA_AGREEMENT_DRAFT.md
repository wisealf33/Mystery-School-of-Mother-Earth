# Mystery School of Mother Earth Foundation Members Association Agreement

**A Private Agreement Members Association**

Current agreement version: `0.2`

Source of truth for the onboarding signature area: `agreement.js`
...
In witness whereof, I set my hand by electronic signature on the date recorded by the membership system.

Member signature:

Printed member name:

As agreed with and witnessed by an authorized member or administrator of the Association.
